...
Route generated pinning and upload mutation requests through the gated Intuition pinning endpoint and require an explicit pinning API key.
...
The gated mutation set includes `pinThing`, `pinPerson`, `pinOrganization`, `uploadJsonToIpfs`, `uploadImage`, and `uploadImageFromUrl`.
