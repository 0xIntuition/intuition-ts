export const multiVaultAbi = [
  ...
  },
  {
    ...
    outputs: [{ name: 'approvalType', type: 'uint8', internalType: 'uint8' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      { name: 'receiver', type: 'address', internalType: 'address' },
      { name: 'termIds', type: 'uint256[]', internalType: 'uint256[]' },
  ...
  {
    type: 'function',
    name: 'batchDepositCurve',
    inputs: [
      { name: 'receiver', type: 'address', internalType: 'address' },
      { name: 'termIds', type: 'uint256[]', internalType: 'uint256[]' },
      { name: 'curveIds', type: 'uint256[]', internalType: 'uint256[]' },
      { name: 'amounts', type: 'uint256[]', internalType: 'uint256[]' },
    ],
    outputs: [{ name: 'shares', type: 'uint256[]', internalType: 'uint256[]' }],
    stateMutability: 'payable',
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'defaultCurveId', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
    type: 'function',
    name: 'bondingCurveVaults',
    inputs: [
  ...
  {
    type: 'function',
    name: 'depositAtomCurve',
    inputs: [
      { name: 'receiver', type: 'address', internalType: 'address' },
      { name: 'atomId', type: 'uint256', internalType: 'uint256' },
      { name: 'curveId', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [{ name: '', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'payable',
  ...
  {
    type: 'function',
    name: 'getCurveVaultState',
    inputs: [
      { name: 'termId', type: 'uint256', internalType: 'uint256' },
      { name: 'curveId', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [
  ...
  {
    type: 'function',
    name: 'getDepositSharesAndFeesCurve',
    inputs: [
      { name: 'assets', type: 'uint256', internalType: 'uint256' },
      { name: 'id', type: 'uint256', internalType: 'uint256' },
      { name: 'curveId', type: 'uint256', internalType: 'uint256' },
  ...
  {
    type: 'function',
    name: 'getRedeemAssetsAndFeesCurve',
    inputs: [
      { name: 'shares', type: 'uint256', internalType: 'uint256' },
      { name: 'id', type: 'uint256', internalType: 'uint256' },
      { name: 'curveId', type: 'uint256', internalType: 'uint256' },
  ...
  {
    type: 'function',
    name: 'getVaultStateForUserCurve',
    inputs: [
      { name: 'vaultId', type: 'uint256', internalType: 'uint256' },
      { name: 'curveId', type: 'uint256', internalType: 'uint256' },
      { name: 'receiver', type: 'address', internalType: 'address' },
  ...
  {
    type: 'function',
    name: 'maxDepositCurve',
    inputs: [{ name: 'curveId', type: 'uint256', internalType: 'uint256' }],
    outputs: [{ name: '', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_defaultCurveId', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  {
    type: 'function',
    name: 'setTotalAtomDepositsOnTripleCreation',
    inputs: [
      {
        name: 'totalAtomDepositsOnTripleCreation',
        type: 'uint256',
  ...
  {
    type: 'event',
    name: 'TotalAtomDepositsOnTripleCreationSet',
    inputs: [
      {
        name: 'newTotalAtomDepositsOnTripleCreation',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
      {
        name: 'oldTotalAtomDepositsOnTripleCreation',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
  ...
  },
  {
    ...
    inputs: [
      { name: 'atomUri', type: 'bytes', internalType: 'bytes' },
      { name: 'atomId', type: 'uint256', internalType: 'uint256' },
    ],
  },
  ...
  {
    type: 'error',
    name: 'EthMultiVault_CannotApproveOrRevokeSelf',
    inputs: [],
  },
  { type: 'error', name: 'EthMultiVault_DeployAccountFailed', inputs: [] },
  { type: 'error', name: 'EthMultiVault_DepositExceedsMaxAssets', inputs: [] },
  {
    type: 'error',
  ...
  { type: 'error', name: 'EthMultiVault_InvalidRegistry', inputs: [] },
  ...
  { type: 'error', name: 'EthMultiVault_RedeemerNotApproved', inputs: [] },
