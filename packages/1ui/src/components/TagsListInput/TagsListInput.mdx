...
<Canvas of={Stories.Stories.EmptyStateVariant} sourceState="shown" />
...
<Canvas of={Stories.TrustCirclesVariant} sourceState="shown" />
...
<Canvas of={Stories.TagsVariant} sourceState="shown" />
