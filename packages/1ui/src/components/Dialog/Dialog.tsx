...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-1 text-center sm:text-left items-center pb-5',
      className,
    )}
    {...props}
  ></div>
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <DialogPrimitive.Close className="text-primary/50 hover:text-primary focus:text-primary focus-visible:outline-none">
