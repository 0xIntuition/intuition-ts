      ...
      <DocumentFragment>
        ...
        >
          <defs>
            ...
            >
              <path
                d="M10 15.75V8.25L15.5 12L10 15.75Z"
                fill="currentColor"
              />
              <path
                clip-rule="evenodd"
            ...
            >
              <path
                d="M7.5 4H11V7.5H7.5V4Z"
                fill="currentColor"
              />
              <path
                d="M13 4H16.5V7.5H13V4Z"
                fill="currentColor"
              />
              <path
                d="M7.5 16.5H11V20H7.5V16.5Z"
                fill="currentColor"
              />
              <path
                d="M13 16.5H16.5V20H13V16.5Z"
                fill="currentColor"
              />
              <path
                d="M7.5 10.15H11V13.75H7.5V10.15Z"
                fill="currentColor"
              />
              <path
                d="M13 10.15H16.5V13.75H13V10.15Z"
                fill="currentColor"
              />
            </symbol>
            <symbol
