...
const dappTag: WithContext<Thing> = {
  ...
  name: 'dApps',
  description:
    'Decentralized applications (dApps) are open-source software applications that run on a peer-to-peer blockchain network rather than a centralized server. dApps are known for their transparency, security, and ability to operate autonomously without interference from third parties.',
  image:
    'https://kingslanduniversity.com/wp-content/uploads/2019/06/dapps-1024x512.jpg',
  url: '',
}
...
const builtOnBaseTag: WithContext<Thing> = {
  ...
  image:
    'https://pbs.twimg.com/profile_images/1729594296289173504/VFXjCIOn_400x400.jpg',
