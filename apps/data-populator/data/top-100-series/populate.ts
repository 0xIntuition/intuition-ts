...
const topSeriesJSON: WithContext<Thing> = {
  ...
  name: 'TV Series',
  description:
    'A TV series that captivates audiences with engaging storylines, compelling characters, and high-quality production. This series has garnered widespread acclaim and continues to be a favorite among viewers.',
  image:
    'https://www.the-sun.com/wp-content/uploads/sites/6/2021/04/NINTCHDBPICT000377559478.jpg?w=620',
  url: '',
}
