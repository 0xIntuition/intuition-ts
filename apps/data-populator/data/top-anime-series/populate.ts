...
const mostUsedPredicates: WithContext<Thing> = {
  ...
  "@type": "Thing",
  "description": "A collection of top-rated anime series known for their outstanding storytelling and animation. Explore highly recommended shows across various genres.",
  "name": "Top Anime Series",
  "image": "https://res.cloudinary.com/dfpwy9nyv/image/upload/v1724857515/remix/dntjoxelebxxoifagfjf.webp"
}
