...
const filepath =
  'src/upcoming-crypto-conferences/data/upcoming-crypto-conferences.csv'
...
const upcomingCryptoConferences: WithContext<Thing> = {
  ...
  image:
    'https://a57.foxnews.com/static.foxbusiness.com/foxbusiness.com/content/uploads/2022/04/720/405/IMG_3119-1.jpg',
}
