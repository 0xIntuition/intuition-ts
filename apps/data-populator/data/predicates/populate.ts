...
const mostUsedPredicates: WithContext<Thing> = {
    ...
    "description": "Predicates facilitate powerful, condition-based querying by defining specific criteria for data retrieval and access within the system. Predicates denote the kind of information or relationship being expressed by a Semantic Triple.",
    "image": "https://res.cloudinary.com/dfpwy9nyv/image/upload/v1724346399/remix/tn2ic4mfh2xjyw68dnf2.png",
