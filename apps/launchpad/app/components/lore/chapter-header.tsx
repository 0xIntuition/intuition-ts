...
export function ChapterHeader({ title, subtitle, image }: ChapterHeaderProps) {
  ...
  return (
    <div
      ref={headerRef}
      className="relative w-full h-[40vh] overflow-hidden bg-background mb-20"
    >
      ...
      <motion.div
        className="absolute inset-0 flex flex-col justify-end p-8 text-foreground"
      ...
      >
        <div className="max-w-4xl mx-auto w-full">
          ...
          <motion.p
            className="text-xl text-primary/50 text-center"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
