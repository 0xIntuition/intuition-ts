      ...
      >
        ...
        <div
          className={cn(
            ...
            'rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-4px_5px_#ffffff0f]',

            // transition
            'transform-gpu transition-all duration-300 ease-in-out',

            // on hover
            'group-hover:shadow-[inset_0_-3px_5px_#ffffff2f]',

            // on click
            'group-active:shadow-[inset_0_-5px_5px_#ffffff2f]',
          )}
        />
