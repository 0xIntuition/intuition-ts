    ...
    <div className="flex flex-col h-full">
      <div className="flex-grow overflow-auto">
        ...
        {!isTransactionStarted && (
          <DialogFooter className="justify-center items-center gap-5 mt-auto">
            <Button
              form={form.id}
              type="submit"
            ...
            >
              {state.status === 'error' ? 'Retry' : 'Create Claim'}
            </Button>
          </DialogFooter>
        )}
      </div>
...
interface CreateClaimFormProps {
  ...
  setSelectedIdentities: React.Dispatch<
  ...
  fields: Record<
    string,
    FieldMetadata<unknown, Record<string, unknown>, string[]>
  >
}
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription className="flex items-start w-full">
          <Text
            variant="caption"
            className="text-foreground/50 w-full text-left"
          >
                          ...
                          <HoverCardContent side="bottom" className="w-80">
                            <ProfileCard
                              ...
                              avatarSrc={
                                ...
                                blockies
                                  .create({
                                    seed: selectedIdentities.object?.user
                                      ?.wallet,
                                  })
                                  .toDataURL()
                              }
