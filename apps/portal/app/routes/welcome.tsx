  ...
  return (
    <div className="relative flex items-center justify-center h-screen overflow-hidden bg-black">
      <video
        ...
        poster="/app/assets/video-poster.jpg" // Add an optional poster image
      ...
      >
        <source
          src={`https://storage.googleapis.com/intuition-ts-assets-v1/relic_legendary_v3_compressed.mp4#t=${videoChunk}`}
          type="video/mp4"
        />
        <track
          kind="captions"
          srcLang="en"
          src="/app/assets/relic_legendary_v2_captions.vtt"
        />
      </video>
      {isLoading && (
